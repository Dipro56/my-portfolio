...
const EducationSection = dynamic(
  () => import('../components/education-section/EducationSection'),
  { ssr: false }
);

const ExtraCurricularSection = dynamic(
  () => import('../components/extra-curricular-section/ExtraCurricularSection'),
  { ssr: true }
);
